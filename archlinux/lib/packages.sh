...
OFFICIAL_PACKAGES=(
    ...
    pipewire pipewire-pulse wireplumber pavucontrol blueman firefox mpv playerctl
    ...
    btop eza fastfetch wakeonlan freerdp bc cmake cpio docker drawing gpu-screen-recorder
